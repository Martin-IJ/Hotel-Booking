      ...
      <div className="md:py-10 md:w-1/2 text-left">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mt-5">
          <div className="flex mb-3 md:mb-0">
            <div className="flex gap-3 flex-col justify-center mr-4">
              <p className="text-xs lg:text-xl"> Start From </p>
              <p className="md:font-bold font-semibold flex text-lg xl:text-5xl">
                ${featuredRoom.price}
              </p>
            </div>
            {featuredRoom.discount ? (
              <div className="flex gap-3 flex-col items-center justify-center mr-4">
                <p className="text-xs lg:text-xl"> Discount </p>
          ...
          <Link
            ...
            className="border h-fit text-center border-tertiary-dark text-tertiary-dark px-3 py-2 lg:py-5 lg:px-7 rounded-2xl font-bold lg:text-xl hover:text-white hover:bg-tertiary-dark duration-300"
          >
            More Details
          </Link>
        </div>
