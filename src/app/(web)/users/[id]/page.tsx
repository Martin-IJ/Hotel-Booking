...
const UserDetails = (props: { params: { id: string } }) => {
  ...
  return (
    <div className="container mx-auto px-2 md:px-4 pt-2 pb-10">
      <div className="grid md:grid-cols-12 gap-10">
        <div className="hidden md:block md:col-span-4 lg:col-span-3 shadow-lg dark:shadow-[#eff0f2] dark:shadow dark:bg-[#1b1b1b] dark:text-white h-fit sticky top-32 bg-[#eff0f2] text-black rounded-lg px-6 py-4">
          ...
          {userData.about && (
            <div className="font-normal py-4 text-left">
              <h6 className="text-xl font-bold pb-1">About</h6>
        ...
        <div className="md:col-span-8 lg:col-span-9">
          ...
          <nav className="sticky top-32 px-2 w-fit mx-auto md:w-full md:px-5 py-3 mb-8 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 mt-7">
            <ol
              className={`${
                currentNav === "bookings" ? "text-blue-600" : "text-gray-700"
              } inline-flex mr-1 md:mr-5 items-center space-x-1 md:space-x-3 duration-300`}
            >
              <li
